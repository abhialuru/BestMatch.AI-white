function Routine({ routine }: { routine: string }) {
  ...
  return (
    <section className="w-full h-fit">
      <h1 className="text-2xl font-bold text-black mb-3 mt-10">
        Skin-care routine Analysis
      </h1>
      <div className="w-[100%] lg:w-[90%] max-h-[80%] shadow-lg shadow-black lg:p-5 mx-auto flex flex-col gap-5 rounded-lg">
        <div className="w-full h-full flex flex-col gap-3">
          <h2 className="text-xl font-bold text-black">Morning Routine</h2>
          <ul className="flex flex-col gap-0.5 px-5">
            {renderSteps(amRoutine)}
          </ul>
        </div>
        <div className="w-full h-full flex flex-col gap-3">
          <h2 className="text-xl font-bold text-black">Night Routine</h2>
          <ul className="flex flex-col gap-0.5 px-5">
